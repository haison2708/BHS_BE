...
namespace BHS.Infrastructure.Migrations
{
    ...
    [Migration("20221007042226_update-giftofloyalty")]
    partial class updategiftofloyalty
    {
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Vendors.RankOfUserSetting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 7, 4, 22, 26, 457, DateTimeKind.Utc).AddTicks(2112));

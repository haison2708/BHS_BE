...
namespace BHS.Infrastructure.Migrations
{
    ...
    [Migration("20221003032009_add-pointsOfUser")]
    partial class addpointsOfUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Users.PointOfUserFromExchangeGift", b =>
                {
                    b.Property<int>("PointOfUserId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PointOfUserId");

                    b.HasIndex("GiftOfLoyaltyId");

                    b.HasIndex("LoyaltyProgramId");

                    b.ToTable("PointOfUserFromExchangeGift", (string)null);
                });

            modelBuilder.Entity("BHS.Domain.Entities.Users.PointOfUserFromQr", b =>
                {
                    b.Property<int>("PointOfUserId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("PointOfUserFromQr", (string)null);
                });

            modelBuilder.Entity("BHS.Domain.Entities.Users.PointOfUserFromRotationLuck", b =>
                {
                    b.Property<int>("PointOfUserId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("PointOfUserFromRotationLuck", (string)null);
                });
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Vendors.RankOfUserSetting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 3, 3, 20, 8, 990, DateTimeKind.Utc).AddTicks(1454));
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Users.PointOfUser", b =>
                {
                    b.HasOne("BHS.Domain.Entities.Fortunes.Fortune", null)
                        .WithMany("PointOfUsers")
                        .HasForeignKey("FortuneId");

                    b.HasOne("BHS.Domain.Entities.LoyaltyPrograms.LoyaltyProgram", null)
                        .WithMany("PointOfUsers")
                        .HasForeignKey("LoyaltyProgramId");

                    b.HasOne("BHS.Domain.Entities.LoyaltyPrograms.ProductParticipatingLoyalty", null)
                        .WithMany("PointOfUsers")
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Users.PointOfUserFromExchangeGift", b =>
                {
                    ...
                    b.HasOne("BHS.Domain.Entities.Users.PointOfUser", "PointOfUser")
                        .WithOne("PointOfUserFromExchangeGift")
                        .HasForeignKey("BHS.Domain.Entities.Users.PointOfUserFromExchangeGift", "PointOfUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Users.PointOfUserFromQr", b =>
                {
                    ...
                    b.HasOne("BHS.Domain.Entities.Users.PointOfUser", "PointOfUser")
                        .WithOne("PointOfUserFromQr")
                        .HasForeignKey("BHS.Domain.Entities.Users.PointOfUserFromQr", "PointOfUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Users.PointOfUserFromRotationLuck", b =>
                {
                    ...
                    b.HasOne("BHS.Domain.Entities.Users.PointOfUser", "PointOfUser")
                        .WithOne("PointOfUserFromRotationLuck")
                        .HasForeignKey("BHS.Domain.Entities.Users.PointOfUserFromRotationLuck", "PointOfUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Users.PointOfUser", b =>
                {
                    b.Navigation("PointOfUserFromExchangeGift");

                    b.Navigation("PointOfUserFromQr");

                    b.Navigation("PointOfUserFromRotationLuck");
                });

...
namespace BHS.Infrastructure.Migrations
{
    ...
    [Migration("20220923064810_update-usersetting-vendor")]
    partial class updateusersettingvendor
    {
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Vendors.RankOfUserSetting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 9, 23, 6, 48, 10, 222, DateTimeKind.Utc).AddTicks(2699));

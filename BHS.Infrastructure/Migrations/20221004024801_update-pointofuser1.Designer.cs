...
namespace BHS.Infrastructure.Migrations
{
    ...
    [Migration("20221004024801_update-pointofuser1")]
    partial class updatepointofuser1
    {
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Vendors.RankOfUserSetting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 4, 2, 48, 0, 789, DateTimeKind.Utc).AddTicks(2842));

...
namespace BHS.Infrastructure.Migrations
{
    ...
    [Migration("20221004024242_update-pointofuser")]
    partial class updatepointofuser
    {
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Vendors.RankOfUserSetting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 4, 2, 42, 42, 47, DateTimeKind.Utc).AddTicks(5544));

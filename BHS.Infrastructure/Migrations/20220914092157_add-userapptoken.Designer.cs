...
namespace BHS.Infrastructure.Migrations
{
    ...
    [Migration("20220914092157_add-userapptoken")]
    partial class adduserapptoken
    {
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Vendors.RankOfUserSetting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 9, 14, 9, 21, 57, 394, DateTimeKind.Utc).AddTicks(8372));

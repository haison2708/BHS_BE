...
namespace BHS.Infrastructure.Migrations
{
    ...
    [Migration("20221004063902_update-giftofuser")]
    partial class updategiftofuser
    {
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Vendors.RankOfUserSetting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 4, 6, 39, 2, 32, DateTimeKind.Utc).AddTicks(7885));

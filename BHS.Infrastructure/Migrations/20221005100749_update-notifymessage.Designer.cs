...
namespace BHS.Infrastructure.Migrations
{
    ...
    [Migration("20221005100749_update-notifymessage")]
    partial class updatenotifymessage
    {
            ...
            modelBuilder.Entity("BHS.Domain.Entities.Vendors.RankOfUserSetting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 5, 10, 7, 49, 62, DateTimeKind.Utc).AddTicks(3145));
